    ...
    <div class="min-h-screen py-6 sm:py-12 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-6 sm:mb-8">
                ...
                <div class="mb-4">
                    <p class="text-base sm:text-xl text-gray-600 mb-2">
                        {{ __('booking_flow.select_apartment_description') }}</p>
                    <div
                        class="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-sm sm:text-lg text-gray-700">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900 mb-3">
                                    {{ __('booking_flow.long_term_rental') }}</h3>
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900 mb-3">
                                    {{ __('booking_flow.short_term_rental') }}</h3>
                                <p class="text-gray-700 leading-relaxed">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
                <div class="mb-4 pb-4 border-b border-gray-200">
                    <h2 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">{{ __('booking_flow.search_by_date') }}
                    </h2>
                ...
                <form method="GET"
                    action="{{ route('booking-flow.search', ['location' => $location->id, 'house' => $house->id]) }}"
                    class="flex flex-col lg:flex-row gap-4 lg:gap-6 items-start lg:items-end">
                    ...
                    <div class="w-full lg:flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="lg:w-full">
                            ...
                            <div class="relative">
                                <input type="text" name="check_in" id="check_in" value="{{ $checkIn }}"
                        ...
                        <div class="lg:w-full">
                            <label for="check_out" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <span
                                    class="text-gray-500 text-xs font-normal ml-1">{{ __('booking_flow.optional_long_term') }}</span>
                            </label>
                            <div class="relative">
                                <input type="text" name="check_out" id="check_out" value="{{ $checkOut }}"
                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm"
                    ...
                    <div class="w-full lg:w-auto flex flex-col sm:flex-row gap-2 lg:gap-2 mt-2 lg:mt-0">
                        <!-- Search Button -->
                        <button type="submit"
                            class="inline-flex items-center justify-center gap-2 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-semibold text-sm shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto lg:w-auto lg:whitespace-nowrap">
                            ...
                            <div class="room-card bg-white rounded-2xl overflow-hidden shadow-lg group">
                                ...
                                <div class="h-48 sm:h-64 bg-gray-200 relative overflow-hidden">
                                    ...
                                    <div class="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                                        <h2 class="text-lg sm:text-2xl font-bold text-white drop-shadow-lg">
                                            {{ $room->name }}</h2>
                                    </div>
                                </div>
                                ...
                                <div class="p-4 sm:p-6">
                                    <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2 text-left">{{ $room->name }}
                                    </h3>
                                    @if ($room->description)
                                        <p class="text-sm sm:text-base text-gray-600 line-clamp-2 mb-3 sm:mb-4 text-left">
                                            {{ Str::limit($room->description, 100) }}</p>
                                    @endif
                                    <div
                                        class="flex flex-col gap-3 mb-3 sm:mb-4">
                                        <div class="flex items-center text-gray-600">
                                            ...
                                            <span class="text-sm">{{ $room->capacity ?? 1 }}
                                                {{ ($room->capacity ?? 1) == 1 ? __('booking.guest') : __('booking.guests') }}</span>
                                        </div>
                                        <div class="text-left">
                                            @php
                                                $isLongTerm =
                                                    empty($checkOut) || $checkOut === null || trim($checkOut) === '';
                                    ...
                                    <button onclick="openRoomDetailsModal({{ $room->id }})"
                                        class="mt-3 sm:mt-4 w-full flex items-center justify-start text-blue-600 font-semibold hover:text-blue-700 transition-colors text-sm py-2">
                ...
                <div class="text-center py-12 bg-white rounded-lg shadow-md">
                    <div class="max-w-md mx-auto">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">
                            {{ __('booking_flow.select_checkin_search') }}</h3>
                    ...
                    <div class="modal-body">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">
                                {{ __('booking_flow.amenities_comfort') }}</h3>
                        ...
                        <div class="flex flex-col justify-center items-center">
                            <a id="modalBookButton" href="#"
                                class="bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-blue-700 transition-colors font-semibold text-lg shadow-lg hover:shadow-xl whitespace-nowrap">
                                Buchen
                            </a>
                        </div>
                    </div>
