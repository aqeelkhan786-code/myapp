    ...
    <div class="min-h-screen py-6 sm:py-12 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-8 sm:mb-12">
                ...
                <p class="text-base sm:text-xl text-gray-600">{{ __('booking_flow.select_apartment_description') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <a href="{{ route('booking.show', $apartment) }}" 
                   class="apartment-card bg-white rounded-2xl overflow-hidden shadow-lg group">
                    ...
                    <div class="swiper apartment-swiper-{{ $apartment->id }} h-48 sm:h-64">
                    ...
                    <div class="p-4 sm:p-6">
                        <h2 class="text-lg sm:text-2xl font-bold text-gray-900 mb-2">{{ $apartment->name }}</h2>
                        @if($apartment->description)
                        <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 line-clamp-2">{{ Str::limit($apartment->description, 100) }}</p>
                        @endif
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3 sm:mb-4">
                            <span class="text-xs sm:text-sm text-gray-500 flex items-center">
                                ...
                                {{ $apartment->capacity }} {{ $apartment->capacity == 1 ? __('booking.guest') : __('booking.guests') }}
                            </span>
                        ...
                        <div class="pt-3 sm:pt-4 border-t border-gray-200">
                            <span class="text-xs sm:text-sm text-blue-600 font-semibold flex items-center group-hover:text-blue-700">
            ...
            <div class="text-center mt-8 sm:mt-12">
                <a href="{{ route('booking-flow.house', $house->location) }}" 
                   class="inline-flex items-center px-4 py-2.5 sm:px-6 sm:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-sm sm:text-base">
