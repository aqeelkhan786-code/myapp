...
📅 Flexible Mietdauer – kurz- oder langfristig möglich">{{ old('amenities_text', $house->amenities_text) }}</textarea>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="button_text" id="button_text" value="{{ old('button_text', $house->button_text) }}"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
