    ...
    <form action="{{ route('admin.rooms.update', $room) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-6">
            <div class="flex items-center">
                <input type="checkbox" name="short_term_allowed" id="short_term_allowed" value="1" 
...
📅 Flexible Mietdauer – kurz- oder langfristig möglich">{{ old('amenities_text', $room->amenities_text) }}</textarea>
