...
@section('title', __('admin.create_property'))

@section('content')
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">{{ __('admin.create_new_property') }}</h1>

    <form action="{{ route('admin.properties.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        @csrf
